...
// Function to flip all tiles to the back image
function flipAllTilesToBack() {
    var tiles = document.querySelectorAll('.flip-container');
...
window.addEventListener('scroll', function() {
    var container = document.querySelector('.flip-panel');
    var containerRect = container.getBoundingClientRect();
    var containerBottom = containerRect.bottom;

    // Check if the user has scrolled within the container
    if (window.scrollY + window.innerHeight > containerBottom) {
        flipAllTilesToBack();
    }
});